...
bool BoundingBox::Intersects(const BoundingBox &other) const {
	// TODO: TEST THIS CODE--FROM SOMEONE ELSE'S
	// MAY HAVE EDGE CASE REGARDING ORDER OF MIN AND MAX POINTS
	return 
...
//
bool CBBox::IsBoxInBox( CBBox &BBox ) // THIS IS THE ONE TO USE FOR COLLISION AVOIDANCE IN FAA DOMAIN
{
